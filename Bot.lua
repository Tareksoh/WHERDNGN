...
-- Grep-confirmed (v3.2.0 cleanup batch 8): post-move, Bot.lua has zero
-- remaining `scoreUrgency(` or `matchPointUrgency(` call sites, so those
-- two helpers stay file-local inside Bot/Bidding.lua and are NOT
-- re-bound here.
